...
const Footer = () => {
  return (
    <div className="font-['Founders_Grotesk_X_Condensed'] w-full flex gap-5 h-screen bg-zinc-900 p-14">
      <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk_X_Condensed"] font-semibold'>
